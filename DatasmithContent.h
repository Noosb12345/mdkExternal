...
public:
	CMember(TEnumAsByte<EComponentMobility>)           Mobility                                                    OFFSET(get<T>, {0x248, 1, 0, 0})
	CMember(EDatasmithAreaLightActorType)              LightType                                                   OFFSET(get<T>, {0x249, 1, 0, 0})
	CMember(EDatasmithAreaLightActorShape)             LightShape                                                  OFFSET(get<T>, {0x24A, 1, 0, 0})
	SMember(FVector2D)                                 Dimensions                                                  OFFSET(getStruct<T>, {0x24C, 8, 0, 0})
	DMember(float)                                     Intensity                                                   OFFSET(get<float>, {0x254, 4, 0, 0})
	CMember(ELightUnits)                               IntensityUnits                                              OFFSET(get<T>, {0x258, 1, 0, 0})
	SMember(FLinearColor)                              Color                                                       OFFSET(getStruct<T>, {0x25C, 16, 0, 0})
	DMember(float)                                     Temperature                                                 OFFSET(get<float>, {0x26C, 4, 0, 0})
	CMember(class UTextureLightProfile*)               IESTexture                                                  OFFSET(get<T>, {0x270, 8, 0, 0})
	DMember(bool)                                      bUseIESBrightness                                           OFFSET(get<bool>, {0x278, 1, 0, 0})
	DMember(float)                                     IESBrightnessScale                                          OFFSET(get<float>, {0x27C, 4, 0, 0})
	SMember(FRotator)                                  Rotation                                                    OFFSET(getStruct<T>, {0x280, 12, 0, 0})
	DMember(float)                                     SourceRadius                                                OFFSET(get<float>, {0x28C, 4, 0, 0})
	DMember(float)                                     SourceLength                                                OFFSET(get<float>, {0x290, 4, 0, 0})
	DMember(float)                                     AttenuationRadius                                           OFFSET(get<float>, {0x294, 4, 0, 0})
	DMember(float)                                     SpotlightInnerAngle                                         OFFSET(get<float>, {0x298, 4, 0, 0})
	DMember(float)                                     SpotlightOuterAngle                                         OFFSET(get<float>, {0x29C, 4, 0, 0})
};
...
public:
	SMember(FDatasmithCameraLookatTrackingSettingsTemplate) LookatTrackingSettings                                 OFFSET(getStruct<T>, {0x30, 56, 0, 0})
};
...
public:
	...
	DMember(bool)                                      bOverride_AutoExposureMethod                                OFFSET(get<bool>, {0x0, 1, 1, 3})
	DMember(bool)                                      bOverride_CameraISO                                         OFFSET(get<bool>, {0x0, 1, 1, 4})
	DMember(bool)                                      bOverride_CameraShutterSpeed                                OFFSET(get<bool>, {0x0, 1, 1, 5})
	...
	SMember(FVector4)                                  ColorSaturation                                             OFFSET(getStruct<T>, {0x10, 16, 0, 0})
	CMember(TEnumAsByte<EAutoExposureMethod>)          AutoExposureMethod                                          OFFSET(get<T>, {0x20, 1, 0, 0})
	DMember(float)                                     CameraISO                                                   OFFSET(get<float>, {0x24, 4, 0, 0})
	DMember(float)                                     CameraShutterSpeed                                          OFFSET(get<float>, {0x28, 4, 0, 0})
	DMember(float)                                     DepthOfFieldFstop                                           OFFSET(get<float>, {0x2C, 4, 0, 0})
};
...
public:
	...
	SMember(FDatasmithPostProcessSettingsTemplate)     PostProcessSettings                                         OFFSET(getStruct<T>, {0x50, 48, 0, 0})
};
...
public:
	...
	// TArray<FString> GetDatasmithUserDataValuesForKey(class UObject* Object, FName Key, bool bPartialMatchKey);               // [0x28a7a70] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataValueForKey
	// FString GetDatasmithUserDataValueForKey(class UObject* Object, FName Key, bool bPartialMatchKey);                        // [0x28a81f0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataKeysAndValuesForValue
	// void GetDatasmithUserDataKeysAndValuesForValue(class UObject* Object, FString StringToMatch, TArray<FName>& OutKeys, TArray<FString>& OutValues); // [0x28a7300] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserData
	// class UDatasmithAssetUserData* GetDatasmithUserData(class UObject* Object);                                              // [0x28a8930] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	CMember(TArray<class ULevelSequence*>)             ImportedSequences                                           OFFSET(get<T>, {0x248, 16, 0, 0})


	/// Functions
	// Function /Script/DatasmithContent.DatasmithImportedSequencesActor.PlayLevelSequence
	// void PlayLevelSequence(class ULevelSequence* SequenceToPlay);                                                            // [0x13ba340] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	SMember(FDatasmithImportBaseOptions)               BaseOptions                                                 OFFSET(getStruct<T>, {0x30, 20, 0, 0})
	SMember(FDatasmithReimportOptions)                 ReimportOptions                                             OFFSET(getStruct<T>, {0x44, 2, 0, 0})
	SMember(FString)                                   Filename                                                    OFFSET(getStruct<T>, {0x48, 16, 0, 0})
	SMember(FString)                                   FilePath                                                    OFFSET(getStruct<T>, {0x58, 16, 0, 0})
	SMember(FString)                                   SourceUri                                                   OFFSET(getStruct<T>, {0x68, 16, 0, 0})
};
...
public:
	SMember(FDatasmithPostProcessSettingsTemplate)     Settings                                                    OFFSET(getStruct<T>, {0x30, 48, 0, 0})
	DMember(bool)                                      bEnabled                                                    OFFSET(get<bool>, {0x60, 1, 1, 0})
	DMember(bool)                                      bUnbound                                                    OFFSET(get<bool>, {0x60, 1, 1, 1})
};
...
public:
	CMember(class UDatasmithScene*)                    Scene                                                       OFFSET(get<T>, {0x248, 8, 0, 0})
	CMember(TMap<FName, TWeakObjectPtr<AActor*>>)      RelatedActors                                               OFFSET(get<T>, {0x250, 80, 0, 0})
};
...
public:
	...
	DMember(bool)                                      bVisible                                                    OFFSET(get<bool>, {0x98, 1, 0, 0})
	DMember(bool)                                      bCastShadow                                                 OFFSET(get<bool>, {0x99, 1, 0, 0})
	CMember(TSet<FName>)                               Tags                                                        OFFSET(get<T>, {0xA0, 80, 0, 0})
};
...
public:
	...
	DMember(bool)                                      bUseHighPrecisionTangentBasis                               OFFSET(get<bool>, {0x0, 1, 1, 4})
	DMember(bool)                                      bUseFullPrecisionUVs                                        OFFSET(get<bool>, {0x0, 1, 1, 5})
	DMember(bool)                                      bGenerateLightmapUVs                                        OFFSET(get<bool>, {0x0, 1, 1, 6})
...
class FDatasmithImportInfo : public MDKBase
{ 
	friend MDKHandler;
	friend MDKBase;
