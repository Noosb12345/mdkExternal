...
public:
	SMember(FLiveLinkSubjectRepresentation)            SubjectRepresentation                                       OFFSET(getStruct<T>, {0xA8, 16, 0, 0})
	CMember(TMap<class UClass*, class ULiveLinkControllerBase*>) ControllerMap                                     OFFSET(get<T>, {0xB8, 80, 0, 0})
	DMember(bool)                                      bUpdateInEditor                                             OFFSET(get<bool>, {0x108, 1, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnLiveLinkUpdated                                           OFFSET(getStruct<T>, {0x110, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnControllerMapUpdatedDelegate                              OFFSET(getStruct<T>, {0x120, 16, 0, 0})
	DMember(bool)                                      bDisableEvaluateLiveLinkWhenSpawnable                       OFFSET(get<bool>, {0x130, 1, 0, 0})
	DMember(bool)                                      bEvaluateLiveLink                                           OFFSET(get<bool>, {0x131, 1, 0, 0})
	DMember(bool)                                      bUpdateInPreviewEditor                                      OFFSET(get<bool>, {0x132, 1, 0, 0})


	/// Functions
	// Function /Script/LiveLinkComponents.LiveLinkComponentController.SetSubjectRepresentation
	// void SetSubjectRepresentation(FLiveLinkSubjectRepresentation InSubjectRepresentation);                                   // [0x1495ed0] Final|Native|Public|BlueprintCallable 
	// Function /Script/LiveLinkComponents.LiveLinkComponentController.GetSubjectRepresentation
	// FLiveLinkSubjectRepresentation GetSubjectRepresentation();                                                               // [0x13f15c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
