...
public:
	SMember(FLinearColor)                              StyleColors                                                 OFFSET(getStruct<T>, {0x0, 992, 0, 0})
};

/// Class /Script/SlateCore.SlateThemeManager
/// Size: 0x09C0 (0x000028 - 0x0009E8)
...
public:
	...
	SMember(FStyleColorList)                           ActiveColors                                                OFFSET(getStruct<T>, {0x38, 2480, 0, 0})
};
...
public:
	...
	SMember(FSlateColor)                               Color                                                       OFFSET(getStruct<T>, {0x10, 20, 0, 0})
	DMember(float)                                     Width                                                       OFFSET(get<float>, {0x24, 4, 0, 0})
	CMember(TEnumAsByte<ESlateBrushRoundingType>)      RoundingType                                                OFFSET(get<T>, {0x28, 1, 0, 0})
	DMember(bool)                                      bUseBrushTransparency                                       OFFSET(get<bool>, {0x29, 1, 0, 0})
};
...
public:
	...
	SMember(FSlateBrushOutlineSettings)                OutlineSettings                                             OFFSET(getStruct<T>, {0x50, 48, 0, 0})
	CMember(class UObject*)                            ResourceObject                                              OFFSET(get<T>, {0x80, 8, 0, 0})
	SMember(FName)                                     ResourceName                                                OFFSET(getStruct<T>, {0x88, 8, 0, 0})
	SMember(FBox2f)                                    UVRegion                                                    OFFSET(getStruct<T>, {0x90, 20, 0, 0})
};
...
public:
	...
	DMember(float)                                     SkewAmount                                                  OFFSET(get<float>, {0x50, 4, 0, 0})
};
...
/// Size: 0x3A28 (0x000008 - 0x003A30)
class FToolBarStyle : public FSlateWidgetStyle
{ 
	friend MDKHandler;
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 14896;
...
public:
	...
	SMember(FMargin)                                   SeparatorPadding                                            OFFSET(getStruct<T>, {0x39B0, 16, 0, 0})
	SMember(FMargin)                                   ComboButtonPadding                                          OFFSET(getStruct<T>, {0x39C0, 16, 0, 0})
	SMember(FMargin)                                   ButtonPadding                                               OFFSET(getStruct<T>, {0x39D0, 16, 0, 0})
	SMember(FMargin)                                   CheckBoxPadding                                             OFFSET(getStruct<T>, {0x39E0, 16, 0, 0})
	SMember(FMargin)                                   BlockPadding                                                OFFSET(getStruct<T>, {0x39F0, 16, 0, 0})
	SMember(FMargin)                                   IndentedBlockPadding                                        OFFSET(getStruct<T>, {0x3A00, 16, 0, 0})
	SMember(FMargin)                                   BackgroundPadding                                           OFFSET(getStruct<T>, {0x3A10, 16, 0, 0})
	SMember(FDeprecateSlateVector2D)                   IconSize                                                    OFFSET(getStruct<T>, {0x3A20, 8, 0, 0})
	DMember(bool)                                      bShowLabels                                                 OFFSET(get<bool>, {0x3A28, 1, 0, 0})
};
...
enum class EStyleColor : uint8_t
{
	...
	EStyleColor__Verbose                                                             = 45,
	EStyleColor__User1                                                               = 46,
	EStyleColor__User2                                                               = 47,
	EStyleColor__User3                                                               = 48,
	EStyleColor__User4                                                               = 49,
	EStyleColor__User5                                                               = 50,
	EStyleColor__User6                                                               = 51,
	EStyleColor__User7                                                               = 52,
	EStyleColor__User8                                                               = 53,
	EStyleColor__User9                                                               = 54,
	EStyleColor__User10                                                              = 55,
	EStyleColor__User11                                                              = 56,
	EStyleColor__User12                                                              = 57,
	EStyleColor__User13                                                              = 58,
	EStyleColor__User14                                                              = 59,
	EStyleColor__User15                                                              = 60,
	EStyleColor__User16                                                              = 61
};
