...
public:
	CMember(class UDestructibleComponent*)             DestructibleComponent                                       OFFSET(get<T>, {0x248, 8, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnActorFracture                                             OFFSET(getStruct<T>, {0x250, 16, 0, 0})
};
...
public:
	DMember(bool)                                      bFractureEffectOverride                                     OFFSET(get<bool>, {0x7A0, 1, 1, 0})
	CMember(TArray<FFractureEffect>)                   FractureEffects                                             OFFSET(get<T>, {0x7A8, 16, 0, 0})
	DMember(bool)                                      bEnableHardSleeping                                         OFFSET(get<bool>, {0x7B8, 1, 0, 0})
	DMember(float)                                     LargeChunkThreshold                                         OFFSET(get<float>, {0x7BC, 4, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnComponentFracture                                         OFFSET(getStruct<T>, {0x7D0, 16, 0, 0})


	/// Functions
	// Function /Script/ApexDestruction.DestructibleComponent.SetDestructibleMesh
	// void SetDestructibleMesh(class UDestructibleMesh* NewMesh);                                                              // [0x13a2900] Final|Native|Public|BlueprintCallable 
	// Function /Script/ApexDestruction.DestructibleComponent.GetDestructibleMesh
	// class UDestructibleMesh* GetDestructibleMesh();                                                                          // [0x13a2870] Final|Native|Public|BlueprintCallable 
	// Function /Script/ApexDestruction.DestructibleComponent.ApplyRadiusDamage
	// void ApplyRadiusDamage(float BaseDamage, FVector& HurtOrigin, float DamageRadius, float ImpulseStrength, bool bFullDamage); // [0x13a29f0] Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/ApexDestruction.DestructibleComponent.ApplyDamage
	// void ApplyDamage(float DamageAmount, FVector& HitLocation, FVector& ImpulseDir, float ImpulseStrength);                  // [0x13a2d60] Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	SMember(FVector2f)                                 UVScale                                                     OFFSET(getStruct<T>, {0x0, 8, 0, 0})
	SMember(FVector2f)                                 UVOffset                                                    OFFSET(getStruct<T>, {0x8, 8, 0, 0})
	SMember(FVector3f)                                 Tangent                                                     OFFSET(getStruct<T>, {0x10, 12, 0, 0})
...
public:
	...
	CMember(TArray<FVector3f>)                         VoronoiSites                                                OFFSET(get<T>, {0x58, 16, 0, 0})
...
public:
	SMember(FDestructibleParameters)                   DefaultDestructibleParameters                               OFFSET(getStruct<T>, {0x498, 136, 0, 0})
	CMember(TArray<FFractureEffect>)                   FractureEffects                                             OFFSET(get<T>, {0x520, 16, 0, 0})
};
