...
public:
	...
	// void StopAnalyzing(class UObject* WorldContextObject);                                                                   // [0x64ffe10] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
	// Function /Script/AudioAnalyzer.AudioAnalyzer.StartAnalyzing
	// void StartAnalyzing(class UObject* WorldContextObject, class UAudioBus* AudioBusToAnalyze);                              // [0x64fff00] Final|BlueprintCosmetic|Native|Public|BlueprintCallable 
};
