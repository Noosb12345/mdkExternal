...
public:
	...
	// void SetAnimationBudgetParameters(class UObject* WorldContextObject, FAnimationBudgetAllocatorParameters& InParameters); // [0x13b2000] Final|Native|Static|Private|HasOutParms|BlueprintCallable 
	// Function /Script/AnimationBudgetAllocator.AnimationBudgetBlueprintLibrary.EnableAnimationBudget
	// void EnableAnimationBudget(class UObject* WorldContextObject, bool bEnabled);                                            // [0x13b2390] Final|Native|Static|Private|BlueprintCallable 
};

/// Class /Script/AnimationBudgetAllocator.SkeletalMeshComponentBudgeted
/// Size: 0x0020 (0x000E30 - 0x000E50)
...
public:
	DMember(bool)                                      bAutoRegisterWithBudgetAllocator                            OFFSET(get<bool>, {0xE48, 1, 1, 0})
	DMember(bool)                                      bAutoCalculateSignificance                                  OFFSET(get<bool>, {0xE48, 1, 1, 1})
	DMember(bool)                                      bShouldUseActorRenderedFlag                                 OFFSET(get<bool>, {0xE48, 1, 1, 2})


	/// Functions
	// Function /Script/AnimationBudgetAllocator.SkeletalMeshComponentBudgeted.SetAutoRegisterWithBudgetAllocator
	// void SetAutoRegisterWithBudgetAllocator(bool bInAutoRegisterWithBudgetAllocator);                                        // [0x13b27d0] Final|Native|Public|BlueprintCallable 
};
