...
public:
	...
	// void ProcessActorState(int32_t& OutState, class AActor* InActor, char CurrentState, char OnDemandState, bool& bShouldProcess); // [0x2894af0] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/AnimationSharing.AnimationSharingStateProcessor.GetAnimationStateEnum
	// class UEnum* GetAnimationStateEnum();                                                                                    // [0x2894ac0] Native|Event|Public|BlueprintEvent 
};
...
public:
	CMember(class UAnimSequence*)                      AnimationToPlay                                             OFFSET(get<T>, {0x318, 8, 0, 0})
	DMember(float)                                     PermutationTimeOffset                                       OFFSET(get<float>, {0x320, 4, 0, 0})
	DMember(float)                                     PlayRate                                                    OFFSET(get<float>, {0x324, 4, 0, 0})
	DMember(bool)                                      bStateBool                                                  OFFSET(get<bool>, {0x328, 1, 0, 0})
	CMember(class UAnimSharingInstance*)               Instance                                                    OFFSET(get<T>, {0x330, 8, 0, 0})


	/// Functions
	// Function /Script/AnimationSharing.AnimSharingStateInstance.GetInstancedActors
	// void GetInstancedActors(TArray<AActor*>& Actors);                                                                        // [0x2895740] Final|Native|Protected|HasOutParms|BlueprintCallable 
};
...
public:
	CMember(TWeakObjectPtr<class USkeletalMeshComponent*>) FromComponent                                           OFFSET(get<T>, {0x318, 8, 0, 0})
	CMember(TWeakObjectPtr<class USkeletalMeshComponent*>) ToComponent                                             OFFSET(get<T>, {0x320, 8, 0, 0})
	DMember(float)                                     BlendTime                                                   OFFSET(get<float>, {0x328, 4, 0, 0})
	DMember(bool)                                      bBlendBool                                                  OFFSET(get<bool>, {0x32C, 1, 0, 0})
};
...
public:
	CMember(TWeakObjectPtr<class USkeletalMeshComponent*>) BaseComponent                                           OFFSET(get<T>, {0x318, 8, 0, 0})
	CMember(TWeakObjectPtr<class UAnimSequence*>)      AdditiveAnimation                                           OFFSET(get<T>, {0x320, 8, 0, 0})
	DMember(float)                                     Alpha                                                       OFFSET(get<float>, {0x328, 4, 0, 0})
	DMember(bool)                                      bStateBool                                                  OFFSET(get<bool>, {0x32C, 1, 0, 0})
};
...
public:
	...
	// void RegisterActorWithSkeletonBP(class AActor* InActor, class USkeleton* SharingSkeleton);                               // [0x28960e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AnimationSharing.AnimationSharingManager.GetAnimationSharingManager
	// class UAnimationSharingManager* GetAnimationSharingManager(class UObject* WorldContextObject);                           // [0x2896500] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AnimationSharing.AnimationSharingManager.CreateAnimationSharingManager
	// bool CreateAnimationSharingManager(class UObject* WorldContextObject, class UAnimationSharingSetup* Setup);              // [0x28962e0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AnimationSharing.AnimationSharingManager.AnimationSharingEnabled
	// bool AnimationSharingEnabled();                                                                                          // [0x28960b0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
