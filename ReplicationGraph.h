...
public:
	CMember(class UReplicationGraphNode_GridSpatialization2D*) GridNode                                            OFFSET(get<T>, {0x570, 8, 0, 0})
	CMember(class UReplicationGraphNode_ActorList*)    AlwaysRelevantNode                                          OFFSET(get<T>, {0x578, 8, 0, 0})
	CMember(TArray<FConnectionAlwaysRelevantNodePair>) AlwaysRelevantForConnectionList                             OFFSET(get<T>, {0x580, 16, 0, 0})
	CMember(TArray<class AActor*>)                     ActorsWithoutNetConnection                                  OFFSET(get<T>, {0x590, 16, 0, 0})
};
...
public:
	CMember(class UNetConnection*)                     Connection                                                  OFFSET(get<T>, {0x0, 8, 0, 0})
	SMember(FVector)                                   LastLocation                                                OFFSET(getStruct<T>, {0x8, 12, 0, 0})
	SMember(FVector)                                   LastOutOfRangeLocationCheck                                 OFFSET(getStruct<T>, {0x14, 12, 0, 0})
};
...
public:
	...
	CMember(TWeakObjectPtr<class AReplicationGraphDebugActor*>) DebugActor                                         OFFSET(get<T>, {0x174, 8, 0, 0})
	CMember(TArray<FLastLocationGatherInfo>)           LastGatherLocations                                         OFFSET(get<T>, {0x180, 16, 0, 0})
	CMember(TArray<class UReplicationGraphNode*>)      ConnectionGraphNodes                                        OFFSET(get<T>, {0x238, 16, 0, 0})
	CMember(class UReplicationGraphNode_TearOff_ForConnection*) TearOffNode                                        OFFSET(get<T>, {0x248, 8, 0, 0})
};
...
public:
	CMember(class UReplicationGraph*)                  ReplicationGraph                                            OFFSET(get<T>, {0x248, 8, 0, 0})
	CMember(class UNetReplicationGraphConnection*)     ConnectionManager                                           OFFSET(get<T>, {0x250, 8, 0, 0})


	/// Functions
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerStopDebugging
	// void ServerStopDebugging();                                                                                              // [0xed2140] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerStartDebugging
	// void ServerStartDebugging();                                                                                             // [0xed2160] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerSetPeriodFrameForClass
	// void ServerSetPeriodFrameForClass(class UClass* Class, int32_t PeriodFrame);                                             // [0xed1d00] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerSetCullDistanceForClass
	// void ServerSetCullDistanceForClass(class UClass* Class, float CullDistance);                                             // [0xed1e90] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerSetConditionalActorBreakpoint
	// void ServerSetConditionalActorBreakpoint(class AActor* Actor);                                                           // [0xed1c10] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerPrintCullDistances
	// void ServerPrintCullDistances();                                                                                         // [0xed1bf0] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerPrintAllActorInfo
	// void ServerPrintAllActorInfo(FString Str);                                                                               // [0xed2020] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerCellInfo
	// void ServerCellInfo();                                                                                                   // [0xed2120] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ClientCellInfo
	// void ClientCellInfo(FVector CellLocation, FVector CellExtent, TArray<AActor*> Actors);                                   // [0xed1980] Net|NetReliableNative|Event|Public|HasDefaults|NetClient 
};
...
public:
	...
	DMember(float)                                     CullDistance                                                OFFSET(get<float>, {0x68, 4, 0, 0})
	DMember(float)                                     CullDistanceSquared                                         OFFSET(get<float>, {0x6C, 4, 0, 0})
};
