...
public:
	...
	SMember(FSoftClassPath)                            GameMode                                                    OFFSET(getStruct<T>, {0x10, 32, 0, 0})
};
...
public:
	...
	SMember(FSoftObjectPath)                           TransitionMap                                               OFFSET(getStruct<T>, {0x38, 32, 0, 0})
	...
	SMember(FSoftClassPath)                            GameInstanceClass                                           OFFSET(getStruct<T>, {0x60, 32, 0, 0})
	SMember(FSoftObjectPath)                           PrologueMap                                                 OFFSET(getStruct<T>, {0x80, 32, 0, 0})
	SMember(FSoftObjectPath)                           GameDefaultMap                                              OFFSET(getStruct<T>, {0xA0, 32, 0, 0})
	SMember(FSoftObjectPath)                           ServerDefaultMap                                            OFFSET(getStruct<T>, {0xC0, 32, 0, 0})
	SMember(FSoftClassPath)                            GlobalDefaultGameMode                                       OFFSET(getStruct<T>, {0xE0, 32, 0, 0})
	SMember(FSoftClassPath)                            GlobalDefaultServerGameMode                                 OFFSET(getStruct<T>, {0x100, 32, 0, 0})
	CMember(TArray<FGameModeName>)                     GameModeMapPrefixes                                         OFFSET(get<T>, {0x120, 16, 0, 0})
	CMember(TArray<FGameModeName>)                     GameModeClassAliases                                        OFFSET(get<T>, {0x130, 16, 0, 0})


	/// Functions
	// Function /Script/EngineSettings.GameMapsSettings.SetSkipAssigningGamepadToPlayer1
	// void SetSkipAssigningGamepadToPlayer1(bool bSkipFirstPlayer);                                                            // [0x4a65cb0] Final|Native|Public|BlueprintCallable 
	// Function /Script/EngineSettings.GameMapsSettings.GetSkipAssigningGamepadToPlayer1
	// bool GetSkipAssigningGamepadToPlayer1();                                                                                 // [0x4a65c90] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EngineSettings.GameMapsSettings.GetGameMapsSettings
	// class UGameMapsSettings* GetGameMapsSettings();                                                                          // [0x4a65da0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	SMember(FSoftObjectPath)                           Thumbnail                                                   OFFSET(getStruct<T>, {0x0, 32, 0, 0})
	SMember(FSoftObjectPath)                           Map                                                         OFFSET(getStruct<T>, {0x20, 32, 0, 0})
