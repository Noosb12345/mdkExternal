...
public:
	...
	// void ExecuteUbergraph(int32_t EntryPoint);                                                                               // [0x3a334c0] Event|Public|BlueprintEvent 
};
...
public:
	...
	SMember(FName)                                     AssetName                                                   OFFSET(getStruct<T>, {0x8, 8, 0, 0})
};
...
public:
	SMember(FTopLevelAssetPath)                        AssetPath                                                   OFFSET(getStruct<T>, {0x0, 16, 0, 0})
	SMember(FString)                                   SubPathString                                               OFFSET(getStruct<T>, {0x10, 16, 0, 0})
};
...
public:
	SMember(FName)                                     PackageName                                                 OFFSET(getStruct<T>, {0x0, 8, 0, 0})
	SMember(FName)                                     PackagePath                                                 OFFSET(getStruct<T>, {0x8, 8, 0, 0})
	SMember(FName)                                     AssetName                                                   OFFSET(getStruct<T>, {0x10, 8, 0, 0})
	SMember(FName)                                     AssetClass                                                  OFFSET(getStruct<T>, {0x18, 8, 0, 0})
	SMember(FTopLevelAssetPath)                        AssetClassPath                                              OFFSET(getStruct<T>, {0x20, 16, 0, 0})
};
...
enum class EUnit : uint8_t
{
	...
	EUnit__Months                                                                    = 52,
	EUnit__Years                                                                     = 53,
	EUnit__Multiplier                                                                = 56,
	EUnit__Percentage                                                                = 55,
	EUnit__Unspecified                                                               = 57
};
