...
public:
	SMember(FLinearColor)                              Color                                                       OFFSET(getStruct<T>, {0x478, 16, 0, 0})
	DMember(float)                                     HoverSizeMultiplier                                         OFFSET(get<float>, {0x488, 4, 0, 0})
	DMember(float)                                     PixelHitDistanceThreshold                                   OFFSET(get<float>, {0x48C, 4, 0, 0})
	CMember(class UGizmoViewContext*)                  GizmoViewContext                                            OFFSET(get<T>, {0x498, 8, 0, 0})


	/// Functions
	// Function /Script/InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState
	// void UpdateWorldLocalState(bool bWorldIn);                                                                               // [0x65c6dc0] Final|Native|Public  
	// Function /Script/InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState
	// void UpdateHoverState(bool bHoveringIn);                                                                                 // [0x65c6eb0] Final|Native|Public  
};
...
public:
	DMember(bool)                                      bIsSelectableInEditor                                       OFFSET(get<bool>, {0x248, 1, 0, 0})
};
...
public:
	...
	SMember(FVector)                                   CurTranslationAxis                                          OFFSET(getStruct<T>, {0xFC, 12, 0, 0})
	SMember(FVector)                                   CurTranslationOrigin                                        OFFSET(getStruct<T>, {0x108, 12, 0, 0})
	SMember(FTransform)                                InitialTransform                                            OFFSET(getStruct<T>, {0x120, 48, 0, 0})
};
...
public:
	...
	SMember(FVector2D)                                 Parameter                                                   OFFSET(getStruct<T>, {0x130, 8, 0, 0})
	SMember(FGizmoVec2ParameterChange)                 LastChange                                                  OFFSET(getStruct<T>, {0x138, 16, 0, 0})
	SMember(FVector)                                   CurTranslationOrigin                                        OFFSET(getStruct<T>, {0x148, 12, 0, 0})
	SMember(FVector)                                   CurTranslationNormal                                        OFFSET(getStruct<T>, {0x154, 12, 0, 0})
	SMember(FVector)                                   CurTranslationAxisX                                         OFFSET(getStruct<T>, {0x160, 12, 0, 0})
	SMember(FVector)                                   CurTranslationAxisY                                         OFFSET(getStruct<T>, {0x16C, 12, 0, 0})
	SMember(FTransform)                                InitialTransform                                            OFFSET(getStruct<T>, {0x180, 48, 0, 0})
};
...
public:
	...
	SMember(FGizmoFloatParameterChange)                LastChange                                                  OFFSET(getStruct<T>, {0xF4, 8, 0, 0})
	SMember(FVector)                                   CurRotationAxis                                             OFFSET(getStruct<T>, {0xFC, 12, 0, 0})
	SMember(FVector)                                   CurRotationOrigin                                           OFFSET(getStruct<T>, {0x108, 12, 0, 0})
	SMember(FTransform)                                InitialTransform                                            OFFSET(getStruct<T>, {0x120, 48, 0, 0})
};
...
public:
	...
	SMember(FVector)                                   CurScaleAxis                                                OFFSET(getStruct<T>, {0x7C, 12, 0, 0})
	SMember(FVector)                                   CurScaleOrigin                                              OFFSET(getStruct<T>, {0x88, 12, 0, 0})
...
public:
	...
	SMember(FVector2D)                                 Parameter                                                   OFFSET(getStruct<T>, {0xB8, 8, 0, 0})
	SMember(FGizmoVec2ParameterChange)                 LastChange                                                  OFFSET(getStruct<T>, {0xC0, 16, 0, 0})
	SMember(FVector)                                   CurScaleOrigin                                              OFFSET(getStruct<T>, {0xD0, 12, 0, 0})
	SMember(FVector)                                   CurScaleNormal                                              OFFSET(getStruct<T>, {0xDC, 12, 0, 0})
	SMember(FVector)                                   CurScaleAxisX                                               OFFSET(getStruct<T>, {0xE8, 12, 0, 0})
	SMember(FVector)                                   CurScaleAxisY                                               OFFSET(getStruct<T>, {0xF4, 12, 0, 0})
...
public:
	...
	SMember(FVector)                                   RotationOrigin                                              OFFSET(getStruct<T>, {0x114, 12, 0, 0})
	SMember(FVector)                                   RotationAxis                                                OFFSET(getStruct<T>, {0x120, 12, 0, 0})
	SMember(FVector)                                   RotationPlaneX                                              OFFSET(getStruct<T>, {0x12C, 12, 0, 0})
	SMember(FVector)                                   RotationPlaneY                                              OFFSET(getStruct<T>, {0x138, 12, 0, 0})
	SMember(FVector)                                   InteractionStartPoint                                       OFFSET(getStruct<T>, {0x144, 12, 0, 0})
	SMember(FVector)                                   InteractionCurPoint                                         OFFSET(getStruct<T>, {0x150, 12, 0, 0})
	DMember(float)                                     InteractionStartAngle                                       OFFSET(get<float>, {0x15C, 4, 0, 0})
	DMember(float)                                     InteractionCurAngle                                         OFFSET(get<float>, {0x160, 4, 0, 0})
};
...
public:
	...
	SMember(FVector)                                   InteractionOrigin                                           OFFSET(getStruct<T>, {0x124, 12, 0, 0})
	SMember(FVector)                                   InteractionAxis                                             OFFSET(getStruct<T>, {0x130, 12, 0, 0})
	SMember(FVector)                                   InteractionStartPoint                                       OFFSET(getStruct<T>, {0x13C, 12, 0, 0})
	SMember(FVector)                                   InteractionCurPoint                                         OFFSET(getStruct<T>, {0x148, 12, 0, 0})
	DMember(float)                                     InteractionStartParameter                                   OFFSET(get<float>, {0x154, 4, 0, 0})
	DMember(float)                                     InteractionCurParameter                                     OFFSET(get<float>, {0x158, 4, 0, 0})
	DMember(float)                                     ParameterSign                                               OFFSET(get<float>, {0x15C, 4, 0, 0})
};
...
public:
	...
	SMember(FVector)                                   BrushPosition                                               OFFSET(getStruct<T>, {0x44, 12, 0, 0})
	SMember(FVector)                                   BrushNormal                                                 OFFSET(getStruct<T>, {0x50, 12, 0, 0})
	DMember(bool)                                      bDrawIndicatorLines                                         OFFSET(get<bool>, {0x5C, 1, 0, 0})
	DMember(bool)                                      bDrawRadiusCircle                                           OFFSET(get<bool>, {0x5D, 1, 0, 0})
	DMember(int32_t)                                   SampleStepCount                                             OFFSET(get<int32_t>, {0x60, 4, 0, 0})
	SMember(FLinearColor)                              LineColor                                                   OFFSET(getStruct<T>, {0x64, 16, 0, 0})
	DMember(float)                                     LineThickness                                               OFFSET(get<float>, {0x74, 4, 0, 0})
	DMember(bool)                                      bDepthTested                                                OFFSET(get<bool>, {0x78, 1, 0, 0})
	DMember(bool)                                      bDrawSecondaryLines                                         OFFSET(get<bool>, {0x79, 1, 0, 0})
	DMember(float)                                     SecondaryLineThickness                                      OFFSET(get<float>, {0x7C, 4, 0, 0})
	SMember(FLinearColor)                              SecondaryLineColor                                          OFFSET(getStruct<T>, {0x80, 16, 0, 0})
...
public:
	CMember(class UPrimitiveComponent*)                TranslateX                                                  OFFSET(get<T>, {0x250, 8, 0, 0})
	CMember(class UPrimitiveComponent*)                TranslateY                                                  OFFSET(get<T>, {0x258, 8, 0, 0})
	CMember(class UPrimitiveComponent*)                TranslateZ                                                  OFFSET(get<T>, {0x260, 8, 0, 0})
	CMember(class UPrimitiveComponent*)                TranslateYZ                                                 OFFSET(get<T>, {0x268, 8, 0, 0})
	CMember(class UPrimitiveComponent*)                TranslateXZ                                                 OFFSET(get<T>, {0x270, 8, 0, 0})
	CMember(class UPrimitiveComponent*)                TranslateXY                                                 OFFSET(get<T>, {0x278, 8, 0, 0})
	CMember(class UPrimitiveComponent*)                RotateX                                                     OFFSET(get<T>, {0x280, 8, 0, 0})
	CMember(class UPrimitiveComponent*)                RotateY                                                     OFFSET(get<T>, {0x288, 8, 0, 0})
	CMember(class UPrimitiveComponent*)                RotateZ                                                     OFFSET(get<T>, {0x290, 8, 0, 0})
	CMember(class UPrimitiveComponent*)                RotationSphere                                              OFFSET(get<T>, {0x298, 8, 0, 0})
	CMember(class UPrimitiveComponent*)                UniformScale                                                OFFSET(get<T>, {0x2A0, 8, 0, 0})
	CMember(class UPrimitiveComponent*)                AxisScaleX                                                  OFFSET(get<T>, {0x2A8, 8, 0, 0})
	CMember(class UPrimitiveComponent*)                AxisScaleY                                                  OFFSET(get<T>, {0x2B0, 8, 0, 0})
	CMember(class UPrimitiveComponent*)                AxisScaleZ                                                  OFFSET(get<T>, {0x2B8, 8, 0, 0})
	CMember(class UPrimitiveComponent*)                PlaneScaleYZ                                                OFFSET(get<T>, {0x2C0, 8, 0, 0})
	CMember(class UPrimitiveComponent*)                PlaneScaleXZ                                                OFFSET(get<T>, {0x2C8, 8, 0, 0})
	CMember(class UPrimitiveComponent*)                PlaneScaleXY                                                OFFSET(get<T>, {0x2D0, 8, 0, 0})
};
...
public:
	...
	SMember(FVector)                                   ExplicitGridSize                                            OFFSET(getStruct<T>, {0x48, 12, 0, 0})
	DMember(bool)                                      bRotationGridSizeIsExplicit                                 OFFSET(get<bool>, {0x54, 1, 0, 0})
	SMember(FRotator)                                  ExplicitRotationGridSize                                    OFFSET(getStruct<T>, {0x58, 12, 0, 0})
	DMember(bool)                                      bSnapToWorldRotGrid                                         OFFSET(get<bool>, {0x64, 1, 0, 0})
	DMember(bool)                                      bUseContextCoordinateSystem                                 OFFSET(get<bool>, {0x65, 1, 0, 0})
	CMember(EToolContextCoordinateSystem)              CurrentCoordinateSystem                                     OFFSET(get<T>, {0x68, 4, 0, 0})
	DMember(bool)                                      bUseContextGizmoMode                                        OFFSET(get<bool>, {0x6C, 1, 0, 0})
	CMember(EToolContextTransformGizmoMode)            ActiveGizmoMode                                             OFFSET(get<T>, {0x6D, 1, 0, 0})
	CMember(TArray<class UPrimitiveComponent*>)        ActiveComponents                                            OFFSET(get<T>, {0x190, 16, 0, 0})
	CMember(TArray<class UInteractiveGizmo*>)          ActiveGizmos                                                OFFSET(get<T>, {0x1A0, 16, 0, 0})
	CMember(class UGizmoConstantFrameAxisSource*)      CameraAxisSource                                            OFFSET(get<T>, {0x200, 8, 0, 0})
	CMember(class UGizmoComponentAxisSource*)          AxisXSource                                                 OFFSET(get<T>, {0x208, 8, 0, 0})
	CMember(class UGizmoComponentAxisSource*)          AxisYSource                                                 OFFSET(get<T>, {0x210, 8, 0, 0})
	CMember(class UGizmoComponentAxisSource*)          AxisZSource                                                 OFFSET(get<T>, {0x218, 8, 0, 0})
	CMember(class UGizmoComponentAxisSource*)          UnitAxisXSource                                             OFFSET(get<T>, {0x220, 8, 0, 0})
	CMember(class UGizmoComponentAxisSource*)          UnitAxisYSource                                             OFFSET(get<T>, {0x228, 8, 0, 0})
	CMember(class UGizmoComponentAxisSource*)          UnitAxisZSource                                             OFFSET(get<T>, {0x230, 8, 0, 0})
	CMember(class UGizmoTransformChangeStateTarget*)   StateTarget                                                 OFFSET(get<T>, {0x238, 8, 0, 0})
};
...
public:
	SMember(FVector)                                   Direction                                                   OFFSET(getStruct<T>, {0x4A8, 12, 0, 0})
	DMember(float)                                     Gap                                                         OFFSET(get<float>, {0x4B4, 4, 0, 0})
	DMember(float)                                     Length                                                      OFFSET(get<float>, {0x4B8, 4, 0, 0})
	DMember(float)                                     Thickness                                                   OFFSET(get<float>, {0x4BC, 4, 0, 0})
};

/// Class /Script/InteractiveToolsFramework.GizmoBoxComponent
/// Size: 0x0048 (0x0004A8 - 0x0004F0)
...
public:
	SMember(FVector)                                   Origin                                                      OFFSET(getStruct<T>, {0x4A8, 12, 0, 0})
	SMember(FQuat)                                     Rotation                                                    OFFSET(getStruct<T>, {0x4C0, 16, 0, 0})
	SMember(FVector)                                   Dimensions                                                  OFFSET(getStruct<T>, {0x4D0, 12, 0, 0})
	DMember(float)                                     LineThickness                                               OFFSET(get<float>, {0x4DC, 4, 0, 0})
	DMember(bool)                                      bRemoveHiddenLines                                          OFFSET(get<bool>, {0x4E0, 1, 0, 0})
	DMember(bool)                                      bEnableAxisFlip                                             OFFSET(get<bool>, {0x4E1, 1, 0, 0})
};

/// Class /Script/InteractiveToolsFramework.GizmoCircleComponent
/// Size: 0x0028 (0x0004A8 - 0x0004D0)
...
public:
	SMember(FVector)                                   Normal                                                      OFFSET(getStruct<T>, {0x4A8, 12, 0, 0})
	DMember(float)                                     Radius                                                      OFFSET(get<float>, {0x4B4, 4, 0, 0})
	DMember(float)                                     Thickness                                                   OFFSET(get<float>, {0x4B8, 4, 0, 0})
	DMember(int32_t)                                   NumSides                                                    OFFSET(get<int32_t>, {0x4BC, 4, 0, 0})
	DMember(bool)                                      bViewAligned                                                OFFSET(get<bool>, {0x4C0, 1, 0, 0})
	DMember(bool)                                      bDrawFullCircle                                             OFFSET(get<bool>, {0x4C1, 1, 0, 0})
	DMember(bool)                                      bOnlyAllowFrontFacingHits                                   OFFSET(get<bool>, {0x4C2, 1, 0, 0})
};
...
public:
	CMember(TWeakObjectPtr<class UMaterialInterface*>) Value                                                       OFFSET(get<T>, {0x0, 8, 0, 0})
...
public:
	...
	SMember(FVector)                                   ViewDependentAxis                                           OFFSET(getStruct<T>, {0xA0, 12, 0, 0})
	DMember(float)                                     ViewDependentAngleTol                                       OFFSET(get<float>, {0xAC, 4, 0, 0})
	DMember(float)                                     ViewDependentAxialMaxCosAngleTol                            OFFSET(get<float>, {0xB0, 4, 0, 0})
	DMember(float)                                     ViewDependentPlanarMinCosAngleTol                           OFFSET(get<float>, {0xB4, 4, 0, 0})
	CMember(EGizmoElementViewAlignType)                ViewAlignType                                               OFFSET(get<T>, {0xB8, 4, 0, 0})
	SMember(FVector)                                   ViewAlignAxis                                               OFFSET(getStruct<T>, {0xBC, 12, 0, 0})
	SMember(FVector)                                   ViewAlignNormal                                             OFFSET(getStruct<T>, {0xC8, 12, 0, 0})
	DMember(float)                                     ViewAlignAxialAngleTol                                      OFFSET(get<float>, {0xD4, 4, 0, 0})
	DMember(float)                                     ViewAlignAxialMaxCosAngleTol                                OFFSET(get<float>, {0xD8, 4, 0, 0})
	DMember(float)                                     PixelHitDistanceThreshold                                   OFFSET(get<float>, {0xDC, 4, 0, 0})
};
...
public:
	SMember(FGizmoElementLineRenderStateAttributes)    LineRenderAttributes                                        OFFSET(getStruct<T>, {0xE0, 60, 0, 0})
	DMember(float)                                     LineThickness                                               OFFSET(get<float>, {0x11C, 4, 0, 0})
	DMember(bool)                                      bScreenSpaceLine                                            OFFSET(get<bool>, {0x120, 1, 0, 0})
	DMember(float)                                     HoverLineThicknessMultiplier                                OFFSET(get<float>, {0x124, 4, 0, 0})
	DMember(float)                                     InteractLineThicknessMultiplier                             OFFSET(get<float>, {0x128, 4, 0, 0})
};
...
public:
	SMember(FVector)                                   Center                                                      OFFSET(getStruct<T>, {0x130, 12, 0, 0})
	SMember(FVector)                                   Axis0                                                       OFFSET(getStruct<T>, {0x13C, 12, 0, 0})
	SMember(FVector)                                   Axis1                                                       OFFSET(getStruct<T>, {0x148, 12, 0, 0})
	DMember(double)                                    Radius                                                      OFFSET(get<double>, {0x158, 8, 0, 0})
	DMember(int32_t)                                   NumSegments                                                 OFFSET(get<int32_t>, {0x160, 4, 0, 0})
	CMember(EGizmoElementPartialType)                  PartialType                                                 OFFSET(get<T>, {0x164, 4, 0, 0})
	DMember(double)                                    PartialStartAngle                                           OFFSET(get<double>, {0x168, 8, 0, 0})
	DMember(double)                                    PartialEndAngle                                             OFFSET(get<double>, {0x170, 8, 0, 0})
	DMember(double)                                    PartialViewDependentMaxCosTol                               OFFSET(get<double>, {0x178, 8, 0, 0})
};
...
public:
	DMember(double)                                    InnerRadius                                                 OFFSET(get<double>, {0x180, 8, 0, 0})
};
...
public:
	CMember(class UGizmoElementCylinder*)              CylinderElement                                             OFFSET(get<T>, {0xE8, 8, 0, 0})
	CMember(class UGizmoElementCone*)                  ConeElement                                                 OFFSET(get<T>, {0xF0, 8, 0, 0})
	CMember(class UGizmoElementBox*)                   BoxElement                                                  OFFSET(get<T>, {0xF8, 8, 0, 0})
	SMember(FVector)                                   Base                                                        OFFSET(getStruct<T>, {0x100, 12, 0, 0})
	SMember(FVector)                                   Direction                                                   OFFSET(getStruct<T>, {0x10C, 12, 0, 0})
	SMember(FVector)                                   SideDirection                                               OFFSET(getStruct<T>, {0x118, 12, 0, 0})
	DMember(float)                                     BodyLength                                                  OFFSET(get<float>, {0x124, 4, 0, 0})
	DMember(float)                                     BodyRadius                                                  OFFSET(get<float>, {0x128, 4, 0, 0})
	DMember(float)                                     HeadLength                                                  OFFSET(get<float>, {0x12C, 4, 0, 0})
	DMember(float)                                     HeadRadius                                                  OFFSET(get<float>, {0x130, 4, 0, 0})
	DMember(int32_t)                                   NumSides                                                    OFFSET(get<int32_t>, {0x134, 4, 0, 0})
	CMember(EGizmoElementArrowHeadType)                HeadType                                                    OFFSET(get<T>, {0x138, 4, 0, 0})
};
...
public:
	SMember(FVector)                                   Center                                                      OFFSET(getStruct<T>, {0xE0, 12, 0, 0})
	SMember(FVector)                                   Dimensions                                                  OFFSET(getStruct<T>, {0xEC, 12, 0, 0})
	SMember(FVector)                                   UpDirection                                                 OFFSET(getStruct<T>, {0xF8, 12, 0, 0})
	SMember(FVector)                                   SideDirection                                               OFFSET(getStruct<T>, {0x104, 12, 0, 0})
};
...
public:
	DMember(bool)                                      bDrawMesh                                                   OFFSET(get<bool>, {0x180, 1, 0, 0})
	DMember(bool)                                      bDrawLine                                                   OFFSET(get<bool>, {0x181, 1, 0, 0})
	DMember(bool)                                      bHitMesh                                                    OFFSET(get<bool>, {0x182, 1, 0, 0})
	DMember(bool)                                      bHitLine                                                    OFFSET(get<bool>, {0x183, 1, 0, 0})
};
...
public:
	SMember(FVector)                                   Origin                                                      OFFSET(getStruct<T>, {0xE0, 12, 0, 0})
	SMember(FVector)                                   Direction                                                   OFFSET(getStruct<T>, {0xEC, 12, 0, 0})
	DMember(float)                                     Height                                                      OFFSET(get<float>, {0xF8, 4, 0, 0})
	DMember(float)                                     Radius                                                      OFFSET(get<float>, {0xFC, 4, 0, 0})
	DMember(int32_t)                                   NumSides                                                    OFFSET(get<int32_t>, {0x100, 4, 0, 0})
};
...
public:
	SMember(FVector)                                   Base                                                        OFFSET(getStruct<T>, {0xE0, 12, 0, 0})
	SMember(FVector)                                   Direction                                                   OFFSET(getStruct<T>, {0xEC, 12, 0, 0})
	DMember(float)                                     Height                                                      OFFSET(get<float>, {0xF8, 4, 0, 0})
	DMember(float)                                     Radius                                                      OFFSET(get<float>, {0xFC, 4, 0, 0})
	DMember(int32_t)                                   NumSides                                                    OFFSET(get<int32_t>, {0x100, 4, 0, 0})
...
public:
	DMember(bool)                                      bConstantScale                                              OFFSET(get<bool>, {0x130, 1, 0, 0})
	DMember(bool)                                      bHitOwner                                                   OFFSET(get<bool>, {0x131, 1, 0, 0})
	CMember(TArray<class UGizmoElementBase*>)          Elements                                                    OFFSET(get<T>, {0x138, 16, 0, 0})
};
...
public:
	SMember(FVector)                                   Center                                                      OFFSET(getStruct<T>, {0x130, 12, 0, 0})
	DMember(float)                                     Width                                                       OFFSET(get<float>, {0x13C, 4, 0, 0})
	DMember(float)                                     Height                                                      OFFSET(get<float>, {0x140, 4, 0, 0})
	SMember(FVector)                                   UpDirection                                                 OFFSET(getStruct<T>, {0x144, 12, 0, 0})
	SMember(FVector)                                   SideDirection                                               OFFSET(getStruct<T>, {0x150, 12, 0, 0})
	DMember(bool)                                      bDrawMesh                                                   OFFSET(get<bool>, {0x15C, 1, 0, 0})
	DMember(bool)                                      bDrawLine                                                   OFFSET(get<bool>, {0x15D, 1, 0, 0})
	DMember(bool)                                      bHitMesh                                                    OFFSET(get<bool>, {0x15E, 1, 0, 0})
	DMember(bool)                                      bHitLine                                                    OFFSET(get<bool>, {0x15F, 1, 0, 0})
};
...
public:
	DMember(double)                                    InnerRadius                                                 OFFSET(get<double>, {0x180, 8, 0, 0})
	DMember(int32_t)                                   NumInnerSlices                                              OFFSET(get<int32_t>, {0x188, 4, 0, 0})
	DMember(bool)                                      bEndCaps                                                    OFFSET(get<bool>, {0x18C, 1, 0, 0})
};
...
public:
	...
	// void SetTransform(FTransform& NewTransform);                                                                             // [0x65ecd80] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/InteractiveToolsFramework.GizmoTransformSource.GetTransform
	// FTransform GetTransform();                                                                                               // [0x65eceb0] Native|Public|HasDefaults|Const 
};
...
public:
	...
	// bool HasTangentVectors();                                                                                                // [0x65ed180] Native|Public|Const  
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors
	// void GetTangentVectors(FVector& TangentXOut, FVector& TangentYOut);                                                      // [0x65ecff0] Native|Public|HasOutParms|HasDefaults|Const 
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetOrigin
	// FVector GetOrigin();                                                                                                     // [0x65ed1b0] Native|Public|HasDefaults|Const 
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetDirection
	// FVector GetDirection();                                                                                                  // [0x2b80f00] Native|Public|HasDefaults|Const 
};
...
public:
	...
	// void UpdateInteractingState(bool bInteracting);                                                                          // [0x65ed320] Native|Public        
	// Function /Script/InteractiveToolsFramework.GizmoClickTarget.UpdateHoverState
	// void UpdateHoverState(bool bHovering);                                                                                   // [0x65ed410] Native|Public        
};
...
public:
	...
	// void UpdateInteractingState(bool bInteracting, uint32_t InPartIdentifier);                                               // [0x65ed750] Native|Public        
	// Function /Script/InteractiveToolsFramework.GizmoClickMultiTarget.UpdateHoverState
	// void UpdateHoverState(bool bHovering, uint32_t InPartIdentifier);                                                        // [0x65ed8d0] Native|Public        
	// Function /Script/InteractiveToolsFramework.GizmoClickMultiTarget.UpdateHittableState
	// void UpdateHittableState(bool bHittable, uint32_t InPartIdentifier);                                                     // [0x65ed5d0] Native|Public        
};
...
public:
	...
	// void UpdateVisibilityState(bool bVisible, uint32_t InPartIdentifier);                                                    // [0x65ed8d0] Native|Public        
};
...
public:
	...
	// void EndUpdate();                                                                                                        // [0x65edc10] Native|Public        
	// Function /Script/InteractiveToolsFramework.GizmoStateTarget.BeginUpdate
	// void BeginUpdate();                                                                                                      // [0x2b9c640] Native|Public        
};
...
public:
	...
	// void SetParameter(FVector2D& NewValue);                                                                                  // [0x65edf70] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter
	// FVector2D GetParameter();                                                                                                // [0x57e5820] Native|Public|HasDefaults|Const 
...
public:
	SMember(FVector)                                   Normal                                                      OFFSET(getStruct<T>, {0x4A8, 12, 0, 0})
	DMember(float)                                     HandleSize                                                  OFFSET(get<float>, {0x4B4, 4, 0, 0})
	DMember(float)                                     Thickness                                                   OFFSET(get<float>, {0x4B8, 4, 0, 0})
	SMember(FVector)                                   Direction                                                   OFFSET(getStruct<T>, {0x4BC, 12, 0, 0})
	DMember(float)                                     Length                                                      OFFSET(get<float>, {0x4C8, 4, 0, 0})
	DMember(bool)                                      bImageScale                                                 OFFSET(get<bool>, {0x4CC, 1, 0, 0})
};

/// Class /Script/InteractiveToolsFramework.GizmoRectangleComponent
/// Size: 0x0038 (0x0004A8 - 0x0004E0)
...
public:
	SMember(FVector)                                   DirectionX                                                  OFFSET(getStruct<T>, {0x4A8, 12, 0, 0})
	SMember(FVector)                                   DirectionY                                                  OFFSET(getStruct<T>, {0x4B4, 12, 0, 0})
	DMember(bool)                                      bOrientYAccordingToCamera                                   OFFSET(get<bool>, {0x4C0, 1, 0, 0})
	DMember(float)                                     OffsetX                                                     OFFSET(get<float>, {0x4C4, 4, 0, 0})
	DMember(float)                                     OffsetY                                                     OFFSET(get<float>, {0x4C8, 4, 0, 0})
	DMember(float)                                     LengthX                                                     OFFSET(get<float>, {0x4CC, 4, 0, 0})
	DMember(float)                                     LengthY                                                     OFFSET(get<float>, {0x4D0, 4, 0, 0})
	DMember(float)                                     Thickness                                                   OFFSET(get<float>, {0x4D4, 4, 0, 0})
	DMember(char)                                      SegmentFlags                                                OFFSET(get<char>, {0x4D8, 1, 0, 0})
};
...
public:
	CMember(class UGizmoLineHandleComponent*)          UpIntervalComponent                                         OFFSET(get<T>, {0x250, 8, 0, 0})
	CMember(class UGizmoLineHandleComponent*)          DownIntervalComponent                                       OFFSET(get<T>, {0x258, 8, 0, 0})
	CMember(class UGizmoLineHandleComponent*)          ForwardIntervalComponent                                    OFFSET(get<T>, {0x260, 8, 0, 0})
};
...
public:
	...
	SMember(FVector)                                   InteractionOrigin                                           OFFSET(getStruct<T>, {0x124, 12, 0, 0})
	SMember(FVector)                                   InteractionNormal                                           OFFSET(getStruct<T>, {0x130, 12, 0, 0})
	SMember(FVector)                                   InteractionAxisX                                            OFFSET(getStruct<T>, {0x13C, 12, 0, 0})
	SMember(FVector)                                   InteractionAxisY                                            OFFSET(getStruct<T>, {0x148, 12, 0, 0})
	SMember(FVector)                                   InteractionStartPoint                                       OFFSET(getStruct<T>, {0x154, 12, 0, 0})
	SMember(FVector)                                   InteractionCurPoint                                         OFFSET(getStruct<T>, {0x160, 12, 0, 0})
	SMember(FVector2D)                                 InteractionStartParameter                                   OFFSET(getStruct<T>, {0x16C, 8, 0, 0})
	SMember(FVector2D)                                 InteractionCurParameter                                     OFFSET(getStruct<T>, {0x174, 8, 0, 0})
	SMember(FVector2D)                                 ParameterSigns                                              OFFSET(getStruct<T>, {0x17C, 8, 0, 0})
};
...
public:
	CMember(class UGizmoTransformChangeStateTarget*)   RepositionStateTarget                                       OFFSET(get<T>, {0x3E0, 8, 0, 0})
};
...
public:
	...
	SMember(FVector)                                   ActiveAxis                                                  OFFSET(getStruct<T>, {0xB0, 12, 0, 0})
	SMember(FVector)                                   DragStartWorldPosition                                      OFFSET(getStruct<T>, {0xBC, 12, 0, 0})
	SMember(FVector)                                   DragCurrentPositionProjected                                OFFSET(getStruct<T>, {0xC8, 12, 0, 0})
	DMember(float)                                     InteractionStartParameter                                   OFFSET(get<float>, {0xD4, 4, 0, 0})
};
...
public:
	...
	SMember(FTransform)                                SharedTransform                                             OFFSET(getStruct<T>, {0xF0, 48, 0, 0})
	SMember(FTransform)                                InitialSharedTransform                                      OFFSET(getStruct<T>, {0x120, 48, 0, 0})
};
...
public:
	CMember(TMap<FString, class UInteractiveToolPropertySet*>) CachedPropertiesMap                                 OFFSET(get<T>, {0x38, 80, 0, 0})
...
public:
	CMember(TWeakObjectPtr<class UWorld*>)             TargetWorld                                                 OFFSET(get<T>, {0xE0, 8, 0, 0})
};

/// Struct /Script/InteractiveToolsFramework.BrushStampData
/// Size: 0x00BC (0x000000 - 0x0000BC)
...
public:
	CMember(class UBrushBaseProperties*)               BrushProperties                                             OFFSET(get<T>, {0xE8, 8, 0, 0})
	DMember(bool)                                      bInBrushStroke                                              OFFSET(get<bool>, {0xF0, 1, 0, 0})
	DMember(float)                                     WorldToLocalScale                                           OFFSET(get<float>, {0xF4, 4, 0, 0})
	SMember(FBrushStampData)                           LastBrushStamp                                              OFFSET(getStruct<T>, {0xF8, 188, 0, 0})
	CMember(TSoftObjectPtr<class UClass*>)             PropertyClass                                               OFFSET(get<T>, {0x1C8, 48, 0, 0})
	CMember(class UBrushStampIndicator*)               BrushStampIndicator                                         OFFSET(get<T>, {0x1F8, 8, 0, 0})
};
...
public:
	...
	CMember(TMap<FString, class UInteractiveToolBuilder*>) ToolBuilders                                            OFFSET(get<T>, {0xE8, 80, 0, 0})
};
...
public:
	...
	CMember(TSoftObjectPtr<class UClass*>)             ToolManagerClass                                            OFFSET(get<T>, {0x300, 48, 0, 0})
};
...
public:
	...
	SMember(FVector)                                   HitNormal                                                   OFFSET(getStruct<T>, {0x10, 12, 0, 0})
	DMember(bool)                                      bHasHitNormal                                               OFFSET(get<bool>, {0x1C, 1, 0, 0})
	DMember(int32_t)                                   HitIdentifier                                               OFFSET(get<int32_t>, {0x20, 4, 0, 0})
	CMember(TWeakObjectPtr<class UObject*>)            HitObject                                                   OFFSET(get<T>, {0x30, 8, 0, 0})
};
...
public:
	SMember(FRay)                                      WorldRay                                                    OFFSET(getStruct<T>, {0x0, 24, 0, 0})
	DMember(bool)                                      bHas2D                                                      OFFSET(get<bool>, {0x18, 1, 0, 0})
	SMember(FVector2D)                                 ScreenPosition                                              OFFSET(getStruct<T>, {0x1C, 8, 0, 0})
};
