...
public:
	SMember(FName)                                     DataStreamName                                              OFFSET(getStruct<T>, {0x0, 8, 0, 0})
	SMember(FName)                                     ClassName                                                   OFFSET(getStruct<T>, {0x8, 8, 0, 0})
	CMember(class UClass*)                             Class                                                       OFFSET(get<T>, {0x10, 8, 0, 0})
	CMember(EDataStreamSendStatus)                     DefaultSendStatus                                           OFFSET(get<T>, {0x18, 1, 0, 0})
	DMember(bool)                                      bAutoCreate                                                 OFFSET(get<bool>, {0x19, 1, 0, 0})
};
...
public:
	SMember(FName)                                     FilterName                                                  OFFSET(getStruct<T>, {0x0, 8, 0, 0})
	SMember(FName)                                     ClassName                                                   OFFSET(getStruct<T>, {0x8, 8, 0, 0})
	SMember(FName)                                     ConfigClassName                                             OFFSET(getStruct<T>, {0x10, 8, 0, 0})
};
...
public:
	DMember(uint32_t)                                  ViewPosRelevancyFrameCount                                  OFFSET(get<uint32_t>, {0x28, 4, 0, 0})
	DMember(float)                                     CellSizeX                                                   OFFSET(get<float>, {0x2C, 4, 0, 0})
	DMember(float)                                     CellSizeY                                                   OFFSET(get<float>, {0x30, 4, 0, 0})
	DMember(float)                                     MaxCullDistance                                             OFFSET(get<float>, {0x34, 4, 0, 0})
	DMember(float)                                     DefaultCullDistance                                         OFFSET(get<float>, {0x38, 4, 0, 0})
	SMember(FVector)                                   MinPos                                                      OFFSET(getStruct<T>, {0x3C, 12, 0, 0})
	SMember(FVector)                                   MaxPos                                                      OFFSET(getStruct<T>, {0x48, 12, 0, 0})
};
...
public:
	SMember(FName)                                     PrioritizerName                                             OFFSET(getStruct<T>, {0x0, 8, 0, 0})
	SMember(FName)                                     ClassName                                                   OFFSET(getStruct<T>, {0x8, 8, 0, 0})
	CMember(class UClass*)                             Class                                                       OFFSET(get<T>, {0x10, 8, 0, 0})
	SMember(FName)                                     ConfigClassName                                             OFFSET(getStruct<T>, {0x18, 8, 0, 0})
	CMember(class UClass*)                             ConfigClass                                                 OFFSET(get<T>, {0x20, 8, 0, 0})
};
...
public:
	SMember(FName)                                     ClassName                                                   OFFSET(getStruct<T>, {0x0, 8, 0, 0})
	DMember(uint32_t)                                  PollFramePeriod                                             OFFSET(get<uint32_t>, {0x8, 4, 0, 0})
	DMember(bool)                                      bIncludeSubclasses                                          OFFSET(get<bool>, {0xC, 1, 0, 0})
};
...
public:
	SMember(FName)                                     ClassName                                                   OFFSET(getStruct<T>, {0x0, 8, 0, 0})
	SMember(FName)                                     DynamicFilterName                                           OFFSET(getStruct<T>, {0x8, 8, 0, 0})
};
...
public:
	SMember(FName)                                     ClassName                                                   OFFSET(getStruct<T>, {0x0, 8, 0, 0})
	SMember(FName)                                     PrioritizerName                                             OFFSET(getStruct<T>, {0x8, 8, 0, 0})
};
...
public:
	SMember(FName)                                     ClassName                                                   OFFSET(getStruct<T>, {0x0, 8, 0, 0})
	DMember(bool)                                      bEnableDeltaCompression                                     OFFSET(get<bool>, {0x8, 1, 0, 0})
};
...
public:
	...
	SMember(FName)                                     DefaultSpatialFilterName                                    OFFSET(getStruct<T>, {0x68, 8, 0, 0})
	SMember(FName)                                     RequiredNetDriverChannelClassName                           OFFSET(getStruct<T>, {0x70, 8, 0, 0})
};
...
public:
	SMember(FName)                                     StructName                                                  OFFSET(getStruct<T>, {0x0, 8, 0, 0})
	DMember(bool)                                      bCanUseStructNetSerializer                                  OFFSET(get<bool>, {0x8, 1, 0, 0})
};
...
public:
	CMember(TWeakObjectPtr<class UStruct*>)            Owner                                                       OFFSET(get<T>, {0x0, 8, 0, 0})
...
public:
	DMember(uint32_t)                                  ChangeMaskStorage                                           OFFSET(get<uint32_t>, {0x108, 8, 0, 0})
};
