...
public:
	...
	CMember(TSoftObjectPtr<class UClass*>)             SoftClass                                                   OFFSET(get<T>, {0x18, 48, 0, 0})
	CMember(class UObject*)                            RawObject                                                   OFFSET(get<T>, {0x48, 8, 0, 0})
	CMember(class UObject*)                            WrappedObject                                               OFFSET(get<T>, {0x50, 8, 0, 0})
	CMember(TWeakObjectPtr<class UMetaData*>)          WeakObject                                                  OFFSET(get<T>, {0x58, 8, 0, 0})
	CMember(TWeakObjectPtr<class UMetaData*>)          SoftObject                                                  OFFSET(get<T>, {0x60, 8, 0, 0})
	SMember(FSoftClassPath)                            ClassPath                                                   OFFSET(getStruct<T>, {0x90, 32, 0, 0})
	SMember(FSoftObjectPath)                           ObjectPath                                                  OFFSET(getStruct<T>, {0xB0, 32, 0, 0})
};
...
public:
	SMember(FVector)                                   Vector                                                      OFFSET(getStruct<T>, {0x0, 12, 0, 0})
	SMember(FVector2D)                                 Vector2D                                                    OFFSET(getStruct<T>, {0xC, 8, 0, 0})
	SMember(FVector4)                                  Vector4                                                     OFFSET(getStruct<T>, {0x20, 16, 0, 0})
	SMember(FMatrix)                                   Matrix                                                      OFFSET(getStruct<T>, {0x30, 64, 0, 0})
	SMember(FPlane)                                    Plane                                                       OFFSET(getStruct<T>, {0x70, 16, 0, 0})
	SMember(FQuat)                                     Quat                                                        OFFSET(getStruct<T>, {0x80, 16, 0, 0})
	SMember(FRotator)                                  Rotator                                                     OFFSET(getStruct<T>, {0x90, 12, 0, 0})
	SMember(FTransform)                                Transform                                                   OFFSET(getStruct<T>, {0xA0, 48, 0, 0})
	SMember(FBox)                                      Box                                                         OFFSET(getStruct<T>, {0xD0, 28, 0, 0})
	SMember(FBox2D)                                    Box2D                                                       OFFSET(getStruct<T>, {0xEC, 20, 0, 0})
	SMember(FBoxSphereBounds)                          BoxSphereBounds                                             OFFSET(getStruct<T>, {0x100, 28, 0, 0})
	SMember(FOrientedBox)                              OrientedBox                                                 OFFSET(getStruct<T>, {0x11C, 60, 0, 0})
	DMember(float)                                     float0                                                      OFFSET(get<float>, {0x158, 4, 0, 0})
	DMember(double)                                    Double                                                      OFFSET(get<double>, {0x160, 8, 0, 0})
	CMember(TArray<FVector>)                           VectorArray                                                 OFFSET(get<T>, {0x168, 16, 0, 0})
	CMember(TMap<FString, FVector>)                    StrToVec                                                    OFFSET(get<T>, {0x178, 80, 0, 0})
	CMember(TSet<FVector>)                             VectorSet                                                   OFFSET(get<T>, {0x1C8, 80, 0, 0})
};
...
public:
	...
	SMember(FStructSerializerObjectTestStruct)         Objects                                                     OFFSET(getStruct<T>, {0x38, 208, 0, 0})
	SMember(FStructSerializerBuiltinTestStruct)        Builtins                                                    OFFSET(getStruct<T>, {0x110, 144, 0, 0})
	...
	SMember(FStructSerializerLWCTypesTest)             LWCTypes                                                    OFFSET(getStruct<T>, {0x480, 544, 0, 0})
};
